...
trainfiles, valfiles, testfiles = readdata.create_sets(opts['img_dir'], train_set_proportion=.45, 
                                                  test_set_proportion=.45,
...
plt.savefig('figs/intenstinal-parasites.png', bbox_inches='tight')
...
from keras.preprocessing import image
import numpy as np
squeezenet_model = SqueezeNet(input_shape=(30,30,3))
...
plt.savefig('figs/intestinal-patchevaluation.png', bbox_inches='tight')
...
plt.savefig('figs/intestinal-patchevaluation2.png', bbox_inches='tight')
...
plt.gcf().set_size_inches(1.5*N_samples_to_display,3) 
plt.savefig('figs/intestinal-falsedetections.png', bbox_inches='tight')
...
plt.gcf().set_size_inches(1.5*N_samples_to_display,3) 
plt.savefig('figs/intestinal-detectedpatches.png', bbox_inches='tight')
...
plt.gcf().set_size_inches(1.5*N_samples_to_display,3) 
plt.savefig('figs/intestinal-lowprob.png', bbox_inches='tight')
...
import detectobjects as det
fname = 'intestinalparasites-phone-0024.jpg'
...
plt.imshow(im)
plt.savefig('figs/intenstinaldata.png', bbox_inches='tight')
